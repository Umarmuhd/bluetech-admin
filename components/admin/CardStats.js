...
export default function CardStats({
  ...
  return (
    <>
      <div className="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-sm border">
        <div className="flex-auto p-4">
          <div className="flex flex-wrap">
            ...
            <div className="relative w-auto pl-4 flex-initial flex items-center">
